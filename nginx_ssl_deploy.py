...
try:
    ...
    print('Nginx stdout:', stdout.read().decode())
    print('Nginx stderr:', stderr.read().decode())
    
    print('Installing certbot...')
    ssh.exec_command('apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install -y certbot python3-certbot-nginx').stdout.read()
