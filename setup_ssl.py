...
try:
    ...
    print('Nginx restart:', stdout.read().decode(), stderr.read().decode())
    
    print('Installing certbot...')
    ssh.exec_command('apt-get update && apt-get install -y certbot python3-certbot-nginx').stdout.read()
    ...
    print('Certbot:', stdout.read().decode(), stderr.read().decode())
